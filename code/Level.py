...
from code.Const import C_WHITE, WIN_HEIGHT, MENU_OPTION, EVENT_ENEMY, SPAWN_TIME, C_GREE, C_CYAN, EVENT_TIMEOUT, \
    ...
    def run(self, player_score: list[int], clock):  # Agora aceita o argumento clock
        ...
        while True:
            ...
            for ent in self.entity_list:
                ...
                if ent.name == 'Player1':
                    self.level_text(text_size, f'Player1 - Health:{ent.health} | Score: {ent.score}', C_GREE, (10, 25))
                if ent.name == 'Player2':
                    self.level_text(text_size, f'Player2 - Health:{ent.health} | Score: {ent.score}', C_CYAN, (10, 45))
